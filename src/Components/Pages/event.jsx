import img from '../../assets/festival.jpg'
...
const Event = () => {
  ...
  return (
    <div className="container mx-auto p-6">
      <h1 className="text-3xl font-bold mb-8">Cultural Events</h1>
        ...
        {events.map((event) => (
          ...
          >
            ...
            <div className="p-4 flex-grow flex flex-col">
              ...
              <p className="text-gray-600 text-sm mb-4">{event.short_description}</p>
