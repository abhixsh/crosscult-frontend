...
const EventDetail = () => {
    ...
    useEffect(() => {
        const fetchEvent = async () => {
            try {
                const response = await axios.get(`https://crossculeventsnew.azurewebsites.net/api/events/${id}`);
    ...
    return (
        ...
        >
            <div className="mb-8 flex justify-between items-center">
                <div>
                    <div className="bg-orange-600 text-white inline-block px-2 py-1 rounded-md mb-2">
                        {event.event_type}
                    </div>
                    <motion.h1
                ...
                <div className="flex flex-col sm:flex-row gap-8 p-6">
                    ...
                    >
                        ...
                        <div className="absolute top-0 right-0 m-4">
                            <div className="bg-orange-600 text-white text-sm px-2 py-1 rounded-md">
